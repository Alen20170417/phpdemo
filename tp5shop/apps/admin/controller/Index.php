...
use apps\admin\model\Menus;
use apps\admin\model\Index as M;
/**
 * ============================================================================
 * WSTMart多用户商城
...
class Index extends Base{
    ...
    public function getSubMenus(){
    	$m = new Menus();
    	$rs = $m->getSubMenus((int)Input('post.id'));
    	return $rs;
    }
    ...
    public function getVersion(){
    	...
    	$content = file_get_contents('http://www.shangtaosoft.com/index.php?m=Api&c=Download&a=getWSTMartLastVersion&key='.$url);
