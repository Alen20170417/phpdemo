...
class Shops extends Validate{
	protected $rule = [
		...
		['shopQQ'  ,'require|max:100','请输入客服QQ|客服QQ不能超过50个字符'],
    ...
    protected $scene = [
        'add'   =>  ['shopName','shopkeeper','telephone','shopCompany','shopTel','isSelf','shopImg','shopQQ',
                     'areaId','shopAddress','isInvoice','shopAtive','bankId','bankNo','bankUserName','shopAtive'],
        'edit'  =>  ['shopName','shopkeeper','telephone','shopCompany','shopTel','isSelf','shopImg','shopQQ',
                     'areaId','shopAddress','isInvoice','shopAtive','bankId','bankNo','bankUserName','shopAtive']
    ]; 
