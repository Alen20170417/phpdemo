 ...
 * 门店申请控制器
 */
use apps\home\model\ShopApplys as M;
...
class Shopapplys extends Base{	
	...
	public function getPhoneVerifyCode(){
		...
		$msg = "欢迎您申请成为".WSTConf("CONF.mallName")."商家，您的注册验证码为:".$phoneVerify."，请在10分钟内输入。【".WSTConf("mallName")."】";
		$m = new LogSms();
	...
	public function protocol(){
		return view("default/shop_protocol");
	}
}
