 ...
 * 商品控制器
 */
use apps\home\model\Goods as M;
...
class Goods extends Base{
    ...
    */
	public function sale(){
		return view('default/shops/goods/list_sale');
	}
	/**
	 * 获取上架商品列表
	 */
    ...
    public function store(){
		return view('default/shops/goods/list_store');
	}
    /**
	 * 审核中的商品
	 */
    public function audit(){
		return view('default/shops/goods/list_audit');
	}
	/**
	 * 获取审核中的商品
	 */
    ...
    public function illegal(){
		return view('default/shops/goods/list_illegal');
	}
	/**
	 * 获取违规的商品
	 */
    ...
    public function lists(){
    	...
    	return view("default/goods_list",$data);
    }
    ...
    public function detail(){
    	...
    	if(!empty($goods)){
	    	...
	    	return view("default/goods_detail");
    	}else{
    		return view("default/error_lost");
    	}
    }
    /**
     * 上传商品数据
    ...
    public function stockwarnbypage(){
    	return view("default/shops/stockwarn/list");
    }
    /**
     * 获取预警库存列表
     */
