...
use apps\home\model\GoodsCats;
use apps\home\model\ShopCats;
use apps\home\model\Shops as M;
class Shops extends Base{
	...
	public function login(){
		...
		return view('default/shop_login');
	}
	/**
	 * 商家中心
	 */
	public function index(){
		...
		return view('default/shops/index');
	}
    /**
     * 店铺街
     */
    public function shopStreet(){
    	...
    	return view('default/shop_street');
    }
    /**
     * 店铺详情
     */
    public function home(){
    	...
    	if(empty($data['shop']))return view('default/error_lost');
    	$sc = new ShopCats();
    	$data['shopcats'] = $sc->getShopCats($shopId);
    	$g = new Goods();
    ...
    public function info(){
    	...
    	return view('default/shops/shops/view');
    }
    /**
    * 自营店铺
    */
    public function selfShop(){
        ...
        if(empty($data['shop']))return view('default/error_lost');
        $sc = new ShopCats();
        $data['shopcats'] = $sc->getShopCats(1);
        ...
        $this->assign('data',$data);
        return view('default/shops/shops/self_shop');
    }
    /**
     * 自营店铺后台
     */
