...
class Users extends Base{
    ...
    */
    public function getById($id){
    	...
    	$rs['ranks'] = Db::table('__USER_RANKS__')->where('startScore','<=',$rs['userTotalScore'])->where('endScore','>=',$rs['userTotalScore'])->field('rankId,rankName,rebate,userrankImg')->find();
    	return $rs;
    }
    /**
     * 编辑资料
