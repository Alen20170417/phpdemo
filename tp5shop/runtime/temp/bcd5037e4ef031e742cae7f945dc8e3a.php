<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:60:"D:\phpStudy\WWW\wstmart_v1/apps/home\view\default\index.html";i:1476943186;s:59:"D:\phpStudy\WWW\wstmart_v1/apps/home\view\default\base.html";i:1476940104;s:71:"D:\phpStudy\WWW\wstmart_v1/apps/home\view\default\self_shop_header.html";i:1476793678;s:65:"D:\phpStudy\WWW\wstmart_v1/apps/home\view\default\header_top.html";i:1476940080;s:65:"D:\phpStudy\WWW\wstmart_v1/apps/home\view\default\shop_apply.html";i:1476943186;s:61:"D:\phpStudy\WWW\wstmart_v1/apps/home\view\default\header.html";i:1476943186;s:61:"D:\phpStudy\WWW\wstmart_v1/apps/home\view\default\footer.html";i:1476943186;}*/ ?>
<!doctype html>
<head>
...
<link href="__ROOT__/apps/home/view/default/css/index.css" rel="stylesheet">
...
<div class='wst-search-container'>
    ...
    <div class="wst-shop-info">
      ...
      <img style="margin:-1px 0px 0px 6px;" src="__ROOT__/apps/home/view/default/img/icon_dianpujie_04.png">
      </a>
      <?php endif; ?>
      </div>
      <div class="wst-shop-info3">
        ...
        <a href='javascript:void(0);' onclick='WST.cancelFavorite(this,1,<?php echo $data['shop']['favShop']; ?>)' class="wst-shop-evaa j-fav">已关注</a>
        <?php else: ?>
        <a href='javascript:void(0);' onclick='WST.addFavorite(this,1,<?php echo $data['shop']['shopId']; ?>)' class="wst-shop-evaa j-fav2">关注店铺</a>
        <?php endif; ?>
...
<div class="index-top-ads">
  <a href="<?php echo $tads['adURL']; ?>" <?php if(($tads['adURL']!='')): ?>onclick="WST.recordClick(<?php echo $tads['adId']; ?>)"<?php endif; ?> onfocus="this.blur();">
                  ...
                  <div class="item-sub" i="<?php echo $k; ?>">
                      <div class="item-brands">
                           <div class="brands-inner">
                            <?php if(is_array($vo['brand']) || $vo['brand'] instanceof \think\Collection): $i = 0;$__LIST__ = is_array($vo['brand']) ? array_slice($vo['brand'],0,16, true) : $vo['brand']->slice(0,16, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$b): $mod = ($i % 2 );++$i;?>
                              <a target="_blank" class="img-link" href="<?php echo url('home/goods/lists',['cat'=>$vo['catId'],'brand'=>$b['brandId']]); ?>">
                                  <img width="83" height="35" class='goodsImg' data-original="__ROOT__/<?php echo $b['brandImg']; ?>">
                              </a>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
      ...
      <div class='wst-right-panel' <?php if(!isset($hideCategory)): ?>style="display:none" <?php endif; ?>>
        <div class="index-user-tab">
          ...
          <?php else: ?>
            ...
            <a href="<?php echo Url('home/users/login'); ?>" style="border-right:1px solid #ccc;"><div class="wst-right-pic"><img src="__ROOT__/apps/home/view/default/img/icon_login.png" /></div>
              <p class="wst-right-text">登录</p>
            </a>
            <a href="<?php echo Url('home/users/regist'); ?>"><div class="wst-right-pic"><img src="__ROOT__/apps/home/view/default/img/icon_register.png" /></div>
        ...
        <ul id="wst-right-new-list"<?php if((!session('WST_USER.userId'))): ?>class="visitor-new-list"<?php endif; ?>  >
          ...
          <li><a href="<?php echo url('home/news/view',['id'=>$vo['articleId']]); ?>"><img src="__ROOT__/apps/home/view/default/img/icon_zixun.png" alt="喇叭"><?php echo $vo['articleTitle']; ?></a></li>
          <?php } ?>
        </ul>
        <div id="wst-right-ads">
          <?php $wstTagAds =  model("Tags")->listAds("index-art-bottom",1,86400); foreach($wstTagAds as $key=>$vo){?>
          <a <?php if(($vo['adURL']!='')): ?>onclick="WST.recordClick(<?php echo $vo['adId']; ?>)"<?php endif; ?> href="<?php echo $vo['adURL']; ?>" onfocus="this.blur()">
	...
	<div class="wst-slide" id="wst-slide">
		<ul class="wst-slide-items">
			<?php $wstTagAds =  model("Tags")->listAds("ads-index",99,86400); foreach($wstTagAds as $key=>$vo){?>
				<a href="<?php echo $vo['adURL']; ?>" <?php if(($vo['adURL']!='')): ?>onclick="WST.recordClick(<?php echo $vo['adId']; ?>)"<?php endif; ?>><li style="background: url(__ROOT__/<?php echo $vo['adFile']; ?>) no-repeat  scroll center top;background-size:cover;" ></li></a>
			<?php } ?>
		</ul>
	...
	<div class="floor-box">
		...
		<div class="floor-left">
			...
			<div class="floor-left-goods">
				...
				<?php $wstTagGoods =  model("Tags")->listGoods("recom",$vo['catId'],10,86400); foreach($wstTagGoods as $key=>$gvo){?>
				<div class='item'>
...
<div id="screen-left-nav" style="display:none;">
	<ul>
		<?php $__FOR_START_22688__=1;$__FOR_END_22688__=$l+1;for($i=$__FOR_START_22688__;$i < $__FOR_END_22688__;$i+=1){  if ($i>10)break;  ?>
...
<script type='text/javascript' src='__ROOT__/apps/home/view/default/js/index.js'></script>
